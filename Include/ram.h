...
extern __mer_core_data__ vector<table*> _R1;
extern __mer_core_data__ vector<table*> _R2;
extern __mer_core_data__ vector<table*> _R3;

__mer_core_data__ void __push_to_ram(table *t, Mer_uint8_t ram);
__mer_core_data__ void __pop_from_ram(Mer_uint8_t ram);
