...
#define CPUSH_TEMP_MODE                         0xAC
#define CPOP_NORMAL_MODE                        0xAD
#define CPOP_TEMP_MODE                          0xAF
#define CPOP_FLOAT                              0x12
#define CPOP_GLOBAL                             0x13
#define CPOP_LOCAL                              0x14
#define CPOP_TEMP                               0x15
#define CPOP_NORMAL                             0x16
#define CPOP_STRING                             0x17
#define CFREE                                   0x18
