...
int MerType_free(_type *type);
int MerFunc_free(_func_object *func);
int MerCode_free(_pcode *code);
int MerObject_free(_object *obj);
int MerVariable_free(_variable *var);
int MerString_free(_string *str);

_object *Merfunc_new(void);
_object *Merobject_new(void);
_object *Merpcode_new(void);
_object *Mercode_new(void);
_object *Merstring_new(void);
_object *Mervariable_new(void);
_object *Mertype_new(void);
