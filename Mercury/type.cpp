...
int MerType_free(_type *type) {return 0;}
int MerFunc_free(_func_object *func) {return 0;}
int MerCode_free(_code *code) {return 0;}
int MerObject_free(_object *obj) {return 0;}
int MerPCode_free(_pcode *pcode) {return 0;}
int MerVariable_free(_variable *var) {return 0;}
int MerString_free(_string *str) {return 0;}
...
_object *Merpcode_new(void) {return 0;}
_object *Merstring_new(void) {return 0;}
_object *Mervariable_new(void) {return 0;}
_object *Mertype_new(void) {return 0;}