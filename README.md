# ⚠️ Warning before read this, this langluage is still in a work in process langluage, if you want to try the full version of the langluage please wait until the version 1.0.1a (beta) is out
