...
all:
	...
	@cmd /c "echo|set /p=merc.exe building... & $(CXX) $(STATIC) -DMERCURY_LANG3 -DSYSTEM_TEST $(BYTECODE_SOURCE_FILE) -o $(BYTECODE_TARGET) > nul 2>&1 && echo [Passed] || echo [Build failed]"
