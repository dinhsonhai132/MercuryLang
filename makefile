...
SOURCE_FILE_TEST = C:\MercuryLang\Program\main1.cpp
...
all:
	...
	@cmd /c "echo|set /p=mer3.exe building... & $(CXX) $(STATIC) $(SOURCE_3_FILE) -o $(BYTECODE_3_TARGET) > nul 2>&1 && echo [Passed] || echo [Build failed]"
