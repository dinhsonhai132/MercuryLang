...
struct token {
    ...
    token(string tok, data_type type, float value, string name, string symbol)
...
static inline bool is_identifier(string iden) {
    ...
    for (string s : state) {
        if (iden == s) return true;
    }
    return false;
}

static inline string return_identifier(string iden) {
    if (iden == "LET") return LET;
    else if (iden == "PRINT") return PRINT;
    else if (iden == "IF") return IF;
    else if (iden == "ELSE") return ELSE;
    else if (iden == "FOR") return FOR;
    else if (iden == "WHILE") return WHILE;
    else if (iden == "RETURN") return RETURN;
    else if (iden == "FUNC") return FUNCTION;
    else if (iden == "INT") return INT;
    else if (iden == "FLOAT") return FLOAT;
    else if (iden == "DOUBLE") return DOUBLE;
    else if (iden == "CHAR") return CHAR;
    else if (iden == "SHORT") return SHORT;
    else if (iden == "LONG") return LONG;
    else if (iden == "AUTO") return AUTO;
    else if (iden == "VOID") return VOID;
    else if (iden == "BOOL") return BOOL;
    else if (iden == "CHAR") return CHAR;
    else if (iden == "STRING") return STRING;
    else if (iden == "STRUCT") return STRUCT;
    else if (iden == "CLASS") return CLASS;
    else if (iden == "INTERFACE") return INTERFACE;
    else if (iden == "NEW") return NEW;
    else if (iden == "DELETE") return DELETE;
    else if (iden == "CAST") return CAST;
    else if (iden == "TRUE") return TRUE;
    else if (iden == "FALSE") return FALSE;
    else if (iden == "BREAK") return BREAK;
    else if (iden == "CONTINUE") return CONTINUE;
    else if (iden == "INCLUDE") return INCLUDE;
    else if (iden == "EXTERN") return EXTERN;
    else if (iden == "USING") return USING;
    else return "";
}
