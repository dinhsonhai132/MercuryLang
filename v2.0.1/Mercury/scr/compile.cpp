...
char *MVM_compile_program(AST_node *ast)
{
    ...
    strcpy(bytecoden, "# Warning: Do not change there bytecode or it will change your program\n");
    strcpy(bytecoden, "# This bytecode is generated by Mercury Virtual Machine (MVM)\n");
    strcpy(bytecoden, "PROGRAM_START\n");

    char *code = MVM_compile_statement(ast);
    if (code) {
