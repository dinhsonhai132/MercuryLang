...
char *MVM_compile_program(AST_node *ast)
{
    ...
    snprintf(bytecoden, BYTECODE_SIZE, "# Warning: Do not change there bytecode or it will change your program\n# This bytecode is generated by Mercury Virtual Machine (MVM)\nPROGRAM_START\n");
    char *code;
...
char *MVM_compile_ast_let_statement(AST_node *ast) {
    ...
    char *var_value = new char[BYTECODE_SIZE];
