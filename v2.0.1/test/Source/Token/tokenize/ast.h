...
#define VarDeclaraion "VarDeclaraion"
...
struct AST_VarDeclaraion : statement {
    string type = VarDeclaraion;
    bool constants;
...
struct AST_PrintStatement : AST_ExprStatement {
    ...
    AST_ExprStatement output;
};

struct AST_VariableDeclare : AST_ExprStatement {
    string type = VarDeclaraion;
    string var_identifier;
    bool constant;
    AST_ExprStatement value;
