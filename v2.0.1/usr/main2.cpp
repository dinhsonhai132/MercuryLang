...
void print_help() {
    cout << COLOR_BOLD << "MercuryLang CLI - " << MERCURY_VERSION << COLOR_RESET << endl;
    cout << "Usage: " << COLOR_YELLOW << "mercury [options] <filename>.mer" << COLOR_RESET << endl;
    cout << "Options:\n";
    cout << "  " << COLOR_GREEN << "--version" << COLOR_RESET << "\t\tShow MERCURY_VERSION information\n";
...
int main(int argc, char* argv[]) {
    ...
    if (arg == "--MERCURY_VERSION") {
        cout << "MercuryLang MERCURY_VERSION " << MERCURY_VERSION << " by " << AUTHOR << endl;
        return EXIT_SUCCESS;
    } 
    if (arg == "--prompt") {
        prompt();
